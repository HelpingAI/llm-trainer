...
class CPOTrainer(BaseFineTuneTrainer):
    _tag_names = ["llm-trainer", "cpo"]

    def __init__(
        self,
        model: Union[str, nn.Module, PreTrainedModel],
        args: Optional[Union[CPOConfig, TrainingArguments]] = None,
        ...
        super().__init__(
            model=model,
            args=args or CPOConfig(output_dir="cpo-output"),
