...
class OnlineDPOTrainer(BaseFineTuneTrainer):
    _tag_names = ["llm-trainer", "online-dpo"]

    def __init__(
        self,
        model: Union[str, nn.Module, PreTrainedModel],
        args: Optional[Union[OnlineDPOConfig, TrainingArguments]] = None,
        ...
        super().__init__(
            model=model,
            args=args or OnlineDPOConfig(output_dir="online-dpo-output"),
