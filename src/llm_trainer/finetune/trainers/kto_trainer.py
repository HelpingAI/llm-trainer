...
class KTOTrainer(BaseFineTuneTrainer):
    _tag_names = ["llm-trainer", "kto"]

    def __init__(
        self,
        model: Union[str, nn.Module, PreTrainedModel],
        args: Optional[Union[KTOConfig, TrainingArguments]] = None,
        ...
        super().__init__(
            model=model,
            args=args or KTOConfig(output_dir="kto-output"),
