...
class NashMDTrainer(BaseFineTuneTrainer):
    _tag_names = ["llm-trainer", "nash-md"]

    def __init__(
        self,
        model: Union[str, nn.Module, PreTrainedModel],
        args: Optional[Union[NashMDConfig, TrainingArguments]] = None,
        ...
        super().__init__(
            model=model,
            args=args or NashMDConfig(output_dir="nash-md-output"),
