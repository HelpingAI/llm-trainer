...
class PRMTrainer(BaseFineTuneTrainer):
    _tag_names = ["llm-trainer", "prm"]

    def __init__(
        self,
        model: Union[str, nn.Module, PreTrainedModel],
        args: Optional[Union[PRMConfig, TrainingArguments]] = None,
        ...
        super().__init__(
            model=model,
            args=args or PRMConfig(output_dir="prm-output"),
