...
class RLOOTrainer(BaseFineTuneTrainer):
    _tag_names = ["llm-trainer", "rloo"]

    def __init__(
        self,
        model: Union[str, nn.Module, PreTrainedModel],
        args: Optional[Union[RLOOConfig, TrainingArguments]] = None,
        ...
        super().__init__(
            model=model,
            args=args or RLOOConfig(output_dir="rloo-output"),
