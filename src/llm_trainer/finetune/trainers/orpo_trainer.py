...
class ORPOTrainer(BaseFineTuneTrainer):
    _tag_names = ["llm-trainer", "orpo"]

    def __init__(
        self,
        model: Union[str, nn.Module, PreTrainedModel],
        args: Optional[Union[ORPOConfig, TrainingArguments]] = None,
        ...
        super().__init__(
            model=model,
            args=args or ORPOConfig(output_dir="orpo-output"),
