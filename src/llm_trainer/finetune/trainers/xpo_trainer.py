...
class XPOTrainer(BaseFineTuneTrainer):
    _tag_names = ["llm-trainer", "xpo"]

    def __init__(
        self,
        model: Union[str, nn.Module, PreTrainedModel],
        args: Optional[Union[XPOConfig, TrainingArguments]] = None,
        ...
        super().__init__(
            model=model,
            args=args or XPOConfig(output_dir="xpo-output"),
